  ...
  return (
    <div className="container mx-auto p-8" id="about">
      ...
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className='col-span-2 px-5 my-auto'>
          <h1 className='text-4xl sm:text-5xl lg:text-8xl font-extrabold'>
            ...
            <br />
            <div className="type-animation-container relative" style={{ height: '2.5rem' }}> {/* Adjust height as needed */}
      ...
      <div className="about-info mt-24 sm:mt-32 md:mt-40 lg:mt-48">
        ...
        I'm Collins, a driven Software developer competent in web development. With expertise in front-end, web design and wordpress, I thrive on tackling challenges and delivering top-notch solutions.
...
As a MERN stack developer, I'm determined to push boundaries and contribute to impactful projects. Let's create something amazing together.
      ...
      <div className='flex justify-center'>
        {/* Download CV button */}
        <a href=" " download="Collins_CV.pdf" onClick={handleDownloadCV} className='lg:mx-4 px-4 py-2 md:px-6 md:py-3 rounded-xl mr-2 bg-gradient-to-br from-orange-500 to-pink-500'>
          Download CV
        </a>
